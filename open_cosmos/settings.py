"""
Django settings for open_cosmos project.
...
SECRET_KEY = 'django-insecure-s8$!rfad@e@icz%4ip4z&6r($u1!*^er7uwro&(y&b84fn+#h_'
...
WSGI_APPLICATION = 'open_cosmos.wsgi.application'
